...
export const copy = {
  ...
  intro: text('Una habitación, un primer bug y toda una ciudad por comprender. Explora una carrera real convertida en una aventura RPG.', 'One room, one first bug, and a whole city to understand. Explore a real career turned into an RPG adventure.'),
  ...
  chapters: text('Selección de capítulo', 'Chapter select'), independent: text('Todos los capítulos están disponibles desde el principio.', 'Every chapter is available from the start.'),
  ...
  controls: text('Flechas / WASD para caminar · E junto a un personaje u objeto · también puedes tocar el mapa.', 'Arrows / WASD to walk · E near a character or object · you can also tap the map.'),
  map: text('Mapa isométrico. Usa las flechas para caminar y E para interactuar.', 'Isometric map. Use arrows to walk and E to interact.'),
